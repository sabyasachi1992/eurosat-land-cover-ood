...
The best model weights (`outputs/best_model.pt`) are excluded from git due to file size. They are generated by running notebook 02 (training). The checkpoint contains:
